    ...
    <>
      {isModalOpen && (
        <>
          ...
          {/* Modal */}
          <div
            className="fixed inset-4 z-50 bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in flex flex-col max-h-[calc(100vh-2rem)]"
          >
            {/* Header */}
            <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-pokemon-blue to-pokemon-purple text-white">
              <div>
                <h2 className="text-2xl font-bold">Meu Deck</h2>
              ...
              {deck.cards.length === 0 ? (
                ...
                <div className="flex-1 flex items-center justify-center p-8">
                  ...
                  >
                    ...
                    <button
                      onClick={closeModal}
                      className="px-6 py-3 bg-pokemon-blue text-white rounded-xl font-medium hover:bg-blue-600 transition-colors"
                    >
                      Explorar cartas
                    </button>
                  </div>
